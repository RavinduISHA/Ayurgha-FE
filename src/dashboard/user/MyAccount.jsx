            ...
            <div className="md:col-span-2 md:px-[30px]">
              <div>
                <button
                  ...
                  } p-2 mr-5 px-5 rounded-md text-heading font-semibold text-[16px] leading-7 border border-solid border-primary`}
                >
                  My Booking
                </button>
                <button
                  ...
                  } p-2 px-5 rounded-md text-heading font-semibold text-[16px] leading-7 border border-solid border-primary`}
                >
                  Profile Settings
                </button>
              </div>
